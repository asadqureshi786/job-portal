    ...
    <section className="web">
      <div className="container">
        ...
        <div className="grid lg:grid-cols-4 gap-5 mt-10">
          {jobs.map((item, index) => (
            <div className="border border-slate-200 rounded-xl p-4 hover:bg-slate-100 transition-all">
              <div className="flex items-center gap-5">
                ...
                <div>
                  <p className="4xl:text-lg text-base font-semibold text-black!">
                    {item.name}
                  </p>
              ...
              <div className="mt-5">
                ...
                <p className="lg:text-base font-normal text-slate-600! leading-5.5 mt-1.5">
              ...
              <div className="flex items-center justify-between mt-5">
                ...
                <button className="btn bg-primary/30 text-primary px-4 py-1.5 rounded-md hover:bg-primary transition-all hover:text-white cursor-pointer">
                  Apply Now
                </button>
              </div>
            </div>
