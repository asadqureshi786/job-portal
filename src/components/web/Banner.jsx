...
export default function Banner() {
    return (
        <div className="h-[calc(100dvh-86px)] relative flex items-center">
            ...
            <div className="flex items-center justify-between">
                <div className="lg:w-6/12">
                    ...
                    <h1 className='text-7xl font-semibold text-black' > <span className='g-text' >Find Jobs</span> Where <br className='lg:inline-block hidden' /> Diversity Thrives</h1>
                    <p className='text-lg mt-4' >Search for roles in organizations that value diversity and <br className='lg:inline-block hidden' /> inclusion that align with your values.</p>
                    ...
                    <div className='mt-10' >
                        ...
                        <img src="/img/companies-group.png" alt="Diverse Talent" className='w-52 mt-4' />
                    </div>

                </div>
                <div className="lg:w-5/12">
                    <div className='bg-[linear-gradient(164deg,rgba(160,83,237,1)_0%,rgba(160,83,237,0.49)_28%,rgba(160,83,237,1)_54%,rgba(160,83,237,0.5)_100%)] absolute top-0 right-6 w-lg h-full rounded-t-4xl' ></div>
                </div>
            </div>
        </div>
        </div>
