...
export default function Banner() {
    return (
        <div className="h-[calc(100dvh-86px)]  flex items-center">
            ...
            <div className="flex items-center justify-between">
                <div className="lg:w-6/12">
                    ...
                    <p className='text-lg text-gray-600 mt-6' >Search for roles in organizations that value diversity and <br className='lg:inline-block hidden' /> inclusion that align with your values.</p>
